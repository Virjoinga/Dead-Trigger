...
public class AnimFSMZombieBossSanta : AnimFSM
{
	public AnimFSMZombieBossSanta(Animation anims, AgentHuman owner)
		: base(anims, owner)
	{
	}
	...
	public override void Initialize()
	{
		...
		AnimStates.Add(AgentActionFactory.E_Type.AttackVomit, new AnimStateAttackVomitPresent(AnimEngine, Owner));
