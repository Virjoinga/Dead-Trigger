...
[AddComponentMenu("Image Effects/MADFINGER SlowTime FX")]
public class MFSlowTimeFX : ImageEffectBase
{
	...
	public static MFSlowTimeFX Instance;
	...
	private void UpdateEmitters()
	{
		...
		for (int num2 = m_ActiveWaves.Count - 1; num2 >= 0; num2--)
		{
			...
			{
				Debug.Log("Removing wave emitter (slot " + m_ActiveWaves[num2].m_SlotIdx + " )");
	...
	private void DbgEmitWave()
	{
		...
		if (button && !m_PrevDbgBtnState)
		{
			...
			EmitGrenadeExplosionWave(normScreenPos, waveParams);
		}
