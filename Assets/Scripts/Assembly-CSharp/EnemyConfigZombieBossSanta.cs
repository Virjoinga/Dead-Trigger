public class EnemyConfigZombieBossSanta : EnemyConfig
{
	private new void Awake()
	{
		base.Awake();
		AnimSet = base.Owner.GameObject.AddComponent<AnimSetZombieBossSanta>();
		base.AnimComponent.SetFSM(E_AnimFSMTypes.ZombieBossSanta);
	}
	...
	private void Start()
	{
		...
		base.Owner.AddGOAPAction(E_GOAPAction.BossSantaGoto);
