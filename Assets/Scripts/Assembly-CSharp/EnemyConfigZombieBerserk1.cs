public class EnemyConfigZombieBerserk1 : EnemyConfig
{
	private new void Awake()
	{
		base.Awake();
		AnimSet = base.Owner.GameObject.AddComponent<AnimSetZombieBerserk1>();
		base.AnimComponent.SetFSM(E_AnimFSMTypes.ZombieNormal);
	}

	protected override void SetProps()
	{
		base.Owner.BlackBoard.MovementSkill = F_MovementSkill.Berserk;
	...
	private void Start()
	{
		...
		base.Owner.WorldState.SetWSProperty(E_PropKey.Berserk, false);
	}
}
