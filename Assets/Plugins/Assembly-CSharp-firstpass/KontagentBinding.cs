...
public class KontagentBinding
{
	...
	/*private static AndroidJavaObject mapFromDictionary(Dictionary<string, string> dict)
	{
		if (dict == null)
		{
	...
	{
		//_plugin.Call("startSession", (apiKey != null) ? apiKey : string.Empty, enableTestMode ? 1 : 0, (senderId != null) ? senderId : string.Empty, shouldSendAPA ? 1 : 0, (apiKeyForTimezone != null) ? apiKeyForTimezone : string.Empty, (apiKeyTimezoneOffset != null) ? apiKeyTimezoneOffset : string.Empty, (fbAppID != null) ? fbAppID : string.Empty);
	}
	...
	{
		string text = null;
		return _plugin.Call<string>(apiKey, new object[0]);
	}
}
