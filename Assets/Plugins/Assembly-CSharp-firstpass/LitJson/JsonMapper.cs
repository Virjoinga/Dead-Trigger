...
namespace LitJson
{
	public class JsonMapper
	{
		...
		private static bool SkipArray(JsonReader reader)
		{
		...
		private static bool SkipObject(JsonReader reader)
		{
			...
			while (reader.Token != JsonToken.ObjectStart);
			...
			else if (reader.Token == JsonToken.ObjectStart)
			{
				...
				while (true)
				{
					...
					else if (!objectMetadata.IsDictionary)
					{
						...
						else if (reader.Token == JsonToken.ObjectStart && !SkipObject(reader))
						{
